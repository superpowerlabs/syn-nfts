...
contract SynCityPassesMock is ERC721, ERC721Enumerable, Ownable {
  ...
  // to test the entire distribution
  uint256 public maxTokenId = 14;
  uint256[] private _remaining = [2, 2, 2];
  ...
  constructor(address _validator) ERC721("Syn Passes Mock", "SYNP") {

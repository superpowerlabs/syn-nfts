...
async function main() {
  ...
  const SynCityCoupons = await ethers.getContractFactory("SynCityCouponsTestNet")
  ...
  const addresses = {
    SynCityCouponsTestNet: nft.address
  }
  ...
  console.log(`
To verify SynCityCouponsTestNet source code:
